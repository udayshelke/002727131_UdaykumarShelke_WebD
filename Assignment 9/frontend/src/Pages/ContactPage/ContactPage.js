          ...
          <div class="col-lg-5">
            <div class="contact-details mb-4 mb-lg-0">
              <p class="mb-3">
                ...
                <span class="fw-medium">support@nujobs.com</span>
              </p>
              <p class="mb-3">
                <i class="mdi mdi-web align-middle text-muted fs-20 me-2"></i>
                <span class="fw-medium">www.nujobs.com</span>
              </p>
              <p class="mb-3">
                <i class="mdi mdi-phone align-middle text-muted fs-20 me-2"></i>
                <span class="fw-medium">+1 (857) 313 8300</span>
              </p>
              <p class="mb-3">
              ...
              <p class="mb-3">
                ...
                <span class="fw-medium">1 longfellow pl 1521, Boston, MA.</span>
              </p>
            </div>
          </div>
          <div class="col-lg-7">
